    ...
    <div className=' min-h-screen p-8 flex flex-col items-center justify-start gap-8'>
      ...
      <div className=' grid grid-cols-2 max-sm:grid-cols-1 gap-8 '>
        ...
        <div className='flex flex-col items-start justify-center gap-4 text-justify'>
          ...
          odpowiednim rozmiarze i kolorze. Zapewniamy szybką dostawę i możliwość
          zwrotu, jeśli garnitur nie spełni Twoich oczekiwań. Chcesz dowiedzieć
          się więcej? Porozmawiajmy o tym, jak wybrać idealny garnitur lub jakie
          są najnowsze trendy w męskiej modzie.
          </p>
          <Link href='/contact' className={`${buttonVariants({
            variant: 'default'})}  text-xl`}>Skontaktuj się z nami <ArrowRight /></Link>
        </div>
      </div>
    </div>
  )
